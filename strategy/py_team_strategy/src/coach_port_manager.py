r""" coach_port_manager.py

* Author        |   Chu, Chen-You
* Date          |   2018/08/23
* Description   |   The port manager of coach 
...
__all__ = ['CoachPortManager']

class CoachPortManager(object):
    """ The port manager of coach 
    function:
        pubRobotRole():
    ...
    args:
        game_state:
            the game state, such as kick off, throw in or penalty kick
        robot_1_role:
            the role of robot 1
        robot_2_role:
            the role of robot 2
    ...
    def _rosSubscriber(self):
        rospy.Subscriber('FIRA/GameState', Int32, self._subGameState)
    ...
    def _subGameState(self, game_state):
